@file:JvmName("ContinuIdResponse")
...
@Serializable data class ContinuIdResponse @JvmOverloads constructor(@JvmField var data: Data? = null): IResponse {
  ...
  companion object {
    ...
    @JvmStatic
    @JvmOverloads
    fun create(data: Data? = null): ContinuIdResponse {
      return ContinuIdResponse(data)
    }

    @JvmStatic
    fun jsonToObject(json: String): ContinuIdResponse {
